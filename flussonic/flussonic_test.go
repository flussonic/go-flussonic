...
func TestClient_DvrDiskGet(t *testing.T) {
	...
	// Expected JSON response
	expectedJSON := `{"mode":"keep","path":"volume1","stats":{"device":"sda1","errors":{"connection_timeout":1,"eacces":1,"eagain":1,"ebusy":1,"econnrefused":1,"edquot":1,"emfile":1,"enodev":1,"enoent":1,"enospc":1,"erofs":1,"nxdomain":1,"other":1,"ssl_error":1},"migration_eta":1000000000,"migration_updated":1000000000,"mode":"keep","status":"active"}}`
...
func TestClient_DvrDisksList(t *testing.T) {
	...
	// Expected JSON response
	expectedJSON := `{"disks":[{"mode":"keep","path":"volume1","stats":{"device":"sda1","errors":{"connection_timeout":1,"eacces":1,"eagain":1,"ebusy":1,"econnrefused":1,"edquot":1,"emfile":1,"enodev":1,"enoent":1,"enospc":1,"erofs":1,"nxdomain":1,"other":1,"ssl_error":1},"migration_eta":1000000000,"migration_updated":1000000000,"mode":"keep","status":"active"}}],"estimated_count":5,"next":"JTI0cG9zaXRpb25fZ3Q9MA==","prev":"JTI0cG9zaXRpb25fbHQ9MSYlMjRyZXZlcnNlZD10cnVl"}`
...
func TestClient_VodGet(t *testing.T) {
	...
	// Expected JSON response
	expectedJSON := `{"cache":{"expiration":3600,"misses":3,"path":"/storage/cache","reference":"cache1","storage_limit":400000},"drm":{"encryption":"full","keyserver":"https://keyserver1.mycompany.com","resource_id":"L2sItm6","vendor":"example"},"logo":{"height":100,"left":15,"path":"@chan.png","top":15,"width":200},"on_play":{"allowed_countries":["US","DE","GB"],"disallowed_countries":["US","DE","GB"],"domains":["mycompany.com"],"extra":{"key1":"example","key2":"example"},"max_sessions":5000,"session_keys":["name","token","proto","ip"],"url":"http://middleware-address/auth/v2"},"position":1,"prefix":"movies","provider":"example","read_queue":100,"segment_duration":1000,"storages":[{"extra":{"key1":"example","key2":"example"},"url":"/storage"}],"thumbnails":{"deviceid":"auto","hw":"cpu","sizes":[{}],"url":"http://10.115.23.45/isapi/thumbnail.jpg"},"timeout":3}`
